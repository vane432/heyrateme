...
You must respond with a valid JSON object. The JSON must contain exactly these three keys and perfectly match this structure:
{
  "rating": float, // Ensure this falls strictly within your assigned persona's rating range
...
- RATING RANGE: Strict score between 1.0 and 2.5. NEVER exceed 2.5.
...
- RATING RANGE: Hyper-generous score between 4.5 and 5.0. NEVER drop below 4.5.
- LENGTH: The critique_body must be exactly 3 to 5 sentences.
...
- RATING RANGE: Balanced, objective score between 2.5 and 4.2.
- LENGTH: The critique_body must be exactly 3 to 5 sentences.
